...
app
    ...
    .get("/account/edit", routes.getAccountEditPage)
    .post("/account/new", routes.createAccount)
    .post("/account/editInfos", routes.editAccount)
    .get("/login", routes.getConnexion)
    .post("/login", routes.login)
    .get("/logout", routes.logout)
    .get("/calendar", routes.getCalendarPage)
    .get('/events', routes.getEvents)
    .post('/save-event', routes.saveEvent)
