 ...
 */
/**
 * Classe DTO de reponse pour la suppression d'un agenda.
 * @implements {ResponseDTO}
 */
class DeleteAgendaResponseDTO extends ResponseDTO {
    /**
     * @param {Errors} errors
     * @param {Agenda} data
     * @param {number} status
...
export { DeleteAgendaResponseDTO };
