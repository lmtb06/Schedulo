 ...
 */
/**
 * Classe DTO de reponse pour la mise à jour d'un agenda.
 * @implements {ResponseDTO}
 */
class UpdateAgendaResponseDTO extends ResponseDTO {
    /**
     * @param {Errors} errors
     * @param {Agenda} data
     * @param {number} status
    ...
    constructor({ errors, data, message, status }) {
        super({
            ...
            message:
                message ||
                (data ? "Agenda mis à jour" : "Le agenda n'existe pas"),
            status: status || (data ? 200 : 404),
        });
    }
}

export { UpdateAgendaResponseDTO };
