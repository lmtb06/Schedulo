...
function recupererElementsPage() {
    elementFormulaireRendezVous = document.querySelector(
        "#formulaireRendezVous"
    );
    elementTitre = elementFormulaireRendezVous.querySelector(
        'input[name="titre"]'
    );
    elementDescription = elementFormulaireRendezVous.querySelector(
        'textarea[name="description"]'
    );
    elementDateDebut = elementFormulaireRendezVous.querySelector(
        'input[name="dateDebut"]'
    );
    elementDateFin = elementFormulaireRendezVous.querySelector(
        'input[name="dateFin"]'
    );
    elementHeureDebut = elementFormulaireRendezVous.querySelector(
        'input[name="heureDebut"]'
    );
    elementHeureFin = elementFormulaireRendezVous.querySelector(
        'input[name="heureFin"]'
    );
    elementBoutonEnregistrer = elementFormulaireRendezVous.querySelector(
        'button[type="submit"]'
    );
}
